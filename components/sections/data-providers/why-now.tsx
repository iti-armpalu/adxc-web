                    ...
                    <div className="space-y-12 sm:space-y-16 max-w-3xl mx-auto">
                        ...
                        <div>
                            ...
                            <div className="flex flex-col gap-4 py-8 md:grid md:grid-cols-[220px_1fr] md:items-center">
                                <div>
                                    <div className="text-4xl font-bold leading-none text-primary-foreground md:text-5xl">80%</div>
                                    <div className="mt-2 text-sm font-medium text-primary-foreground md:text-base">of businesses</div>
                                </div>
                                <p className="text-base text-primary-foreground md:text-lg leading-relaxed">
                        ...
                        <p className="text-2xl sm:text-3xl font-semibold tracking-tight text-primary-foreground/70">
                            SMEs don't have the data to fuel these agents.{" "}
                            <span className="text-primary-foreground">You do.</span>
                        </p>
